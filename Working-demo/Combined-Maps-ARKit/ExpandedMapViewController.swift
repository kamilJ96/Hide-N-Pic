...
class ExpandedMapViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let location = LocationObject(title: "You", locationName: "player1", coordinate: CLLocationCoordinate2D(latitude: (playerLocation?.coordinate.latitude)!-0.0005, longitude: (playerLocation?.coordinate.longitude)!-0.0005))
